...
class Worker(models.Model):
    ...
    image = models.ImageField(verbose_name=_('image'), default="default.jpeg", upload_to='profile_pics')
...
class Company(models.Model):
    ...
    image = models.ImageField(verbose_name=_('image'), default="default.jpeg", upload_to='company_pics')
